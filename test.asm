...
main(int argc,char * argv[])
{
  ...
  printf(1,"Std ID : %d\n",abdur_rouf());
  11:	e8 fc 02 00 00       	call   312 <abdur_rouf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 35f:	f7 f6                	div    %esi
 361:	0f b6 92 f4 06 00 00 	movzbl 0x6f4(%edx),%edx
  }while((x /= base) != 0);
...
free(void *ap)
{
 ...
 561:	a1 8c 09 00 00       	mov    0x98c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5b9:	a3 8c 09 00 00       	mov    %eax,0x98c
}
 5be:	5b                   	pop    %ebx
 5bf:	5e                   	pop    %esi
 5c0:	5f                   	pop    %edi
 ...
 5da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5dd:	a3 8c 09 00 00       	mov    %eax,0x98c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 5f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5fc:	8b 15 8c 09 00 00    	mov    0x98c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 64f:	76 3f                	jbe    690 <malloc+0xa0>
    ...
    if(p == freep)
 651:	39 05 8c 09 00 00    	cmp    %eax,0x98c
 ...
 676:	e8 e5 fe ff ff       	call   560 <free>
  return freep;
 67b:	8b 15 8c 09 00 00    	mov    0x98c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 69c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 69f:	89 15 8c 09 00 00    	mov    %edx,0x98c
      return (void*)(p + 1);
 ...
 6b4:	eb e9                	jmp    69f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6b6:	c7 05 8c 09 00 00 90 	movl   $0x990,0x98c
 6bd:	09 00 00 
 6c0:	c7 05 90 09 00 00 90 	movl   $0x990,0x990
 6c7:	09 00 00 
    base.s.size = 0;
 6ca:	b8 90 09 00 00       	mov    $0x990,%eax
 6cf:	c7 05 94 09 00 00 00 	movl   $0x0,0x994
 6d6:	00 00 00 
